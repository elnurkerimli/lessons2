...
package com.developer.springbootmultithreadingexample.service;

import com.developer.springbootmultithreadingexample.entity.User;
import com.developer.springbootmultithreadingexample.repository.UserRepository;
...
public class UserService {
    ...
    public CompletableFuture<List<User>> saveUsers(MultipartFile file) throws Exception {
        ...
        logger.info("saving list users of size {}", users.size(), "" + Thread.currentThread().getName());
